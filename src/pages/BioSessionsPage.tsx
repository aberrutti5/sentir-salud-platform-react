    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white">
      ...
      <section className="relative z-10 py-16">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-white mb-6">¿Listo para iniciar tu transformación?</h2>
          <p className="text-lg text-white mb-8">
            Contáctanos hoy mismo para agendar tu primera sesión de Biodescodificación y comienza tu camino hacia el bienestar.
          </p>
          <button
            onClick={handleWhatsAppClick}
            className="bg-white text-green-600 font-bold px-8 py-3 rounded-md hover:bg-gray-100 transition-colors inline-flex items-center gap-2"
          >
